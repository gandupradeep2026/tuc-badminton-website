...
export default function RegistrationPage({ onNavigate }) {
  ...
  const [playerLevel, setPlayerLevel] = useState('Fortgeschritten');
  const [playerFav, setPlayerFav] = useState('');
  const [playerEmail, setPlayerEmail] = useState('');
  const [playerPhone, setPlayerPhone] = useState('');
  const [playerUniType, setPlayerUniType] = useState('tu_chemnitz');
  const [playerUniName, setPlayerUniName] = useState('');
