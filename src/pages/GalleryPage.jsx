...
export default function GalleryPage() {
  ...
  return (
    <div className="space-y-6 sm:space-y-8 pb-16">
      ...
      {/* UNI Badminton Team Cup 2026 Report Banner */}
      <div className="rounded-2xl sm:rounded-3xl bg-slate-900 text-white p-5 sm:p-6 flex flex-col md:flex-row md:items-center justify-between gap-4 shadow-sm border border-slate-800">
        <div className="space-y-1 max-w-2xl">
          <div className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full bg-amber-400 text-amber-950 font-bold text-[10px] tracking-wide uppercase">
            🏆 {isDe ? 'Offizieller Ergebnisbericht' : 'Official Results Report'}
          </div>
          <h3 className="text-base sm:text-lg font-black text-white">
            UNI Badminton Team Cup 2026 • {isDe ? 'Fotodokumentation & Statistiken' : 'Photo Documentation & Stats'}
          </h3>
          <p className="text-xs text-slate-300 leading-relaxed">
            {isDe
              ? 'Der vollständige 12-seitige Turnierbericht mit Einzelauswertungen aller 45 Spieler*innen, Team-Statistiken und Urkunden steht als PDF bereit.'
